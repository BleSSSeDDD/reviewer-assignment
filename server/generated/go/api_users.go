...
func (c *UsersAPIController) UsersSetIsActivePost(w http.ResponseWriter, r *http.Request) {
	var usersSetIsActivePostRequestParam UsersSetIsActivePostRequest
	...
	if err := AssertUsersSetIsActivePostRequestRequired(usersSetIsActivePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertUsersSetIsActivePostRequestConstraints(usersSetIsActivePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
