...
// UsersAPIService is a service that implements the logic for the UsersAPIService
...
func (s *UsersAPIService) UsersSetIsActivePost(ctx context.Context, req UsersSetIsActivePostRequest) (ImplResponse, error) {
	...
	err = storage.CreateOrUpdateUser(ctx, transaction, req.UserId, storageUser.Username, storageUser.TeamName, req.IsActive)
	if err != nil {
