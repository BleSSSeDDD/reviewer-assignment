...
func (c *PullRequestsAPIController) PullRequestCreatePost(w http.ResponseWriter, r *http.Request) {
	var pullRequestCreatePostRequestParam PullRequestCreatePostRequest
	...
	if err := AssertPullRequestCreatePostRequestRequired(pullRequestCreatePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertPullRequestCreatePostRequestConstraints(pullRequestCreatePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
...
func (c *PullRequestsAPIController) PullRequestMergePost(w http.ResponseWriter, r *http.Request) {
	var pullRequestMergePostRequestParam PullRequestMergePostRequest
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	...
	if err := AssertPullRequestMergePostRequestRequired(pullRequestMergePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertPullRequestMergePostRequestConstraints(pullRequestMergePostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
...
func (c *PullRequestsAPIController) PullRequestReassignPost(w http.ResponseWriter, r *http.Request) {
	var pullRequestReassignPostRequestParam PullRequestReassignPostRequest
	d := json.NewDecoder(r.Body)
	d.DisallowUnknownFields()
	...
	if err := AssertPullRequestReassignPostRequestRequired(pullRequestReassignPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
	if err := AssertPullRequestReassignPostRequestConstraints(pullRequestReassignPostRequestParam); err != nil {
		c.errorHandler(w, r, err, nil)
		return
	}
