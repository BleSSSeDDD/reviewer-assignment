e2e-тест e2etest.js: 
тест проверяет создание команды с пользователями, создание Pull Request, невозможность переназначения из-за отсутствия кандидатов, 
смену isActive поля пользователя, мерж PR, а также обработку ошибочных сценариев: дублирование команд, обращение к несуществующим командам и пользователям,
попытки изменить PR в статусе MERGED. Все тестовые данные изолированы с помощью timestamp.

вывод k6:

  █ TOTAL RESULTS

    checks_total.......: 12      203.343613/s
    ...
    ✓ ошибка no_candidate при переназначении
    ✓ код ошибки no_candidate
    ✓ обновление статуса пользователя
    ✓ merge pr
    ✓ ошибка дублирования команды
    ✓ ошибка несуществующей команды
    ✓ ошибка несуществующего автора
    ✓ ошибка переназначения на merged pr

    HTTP
    http_req_duration..............: avg=4.76ms  min=1.98ms  med=5.02ms  max=7.56ms  p(90)=7.54ms  p(95)=7.55ms
      { expected_response:true }...: avg=6.28ms  min=3.57ms  med=6.56ms  max=7.56ms  p(90)=7.55ms  p(95)=7.56ms
    http_req_failed................: 45.45% 5 out of 11
    http_reqs......................: 11     186.398312/s

    EXECUTION
    iteration_duration.............: avg=58.73ms min=58.73ms med=58.73ms max=58.73ms p(90)=58.73ms p(95)=58.73ms
    iterations.....................: 1      16.945301/s

    NETWORK
    data_received..................: 2.8 kB 48 kB/s
    data_sent......................: 2.3 kB 40 kB/s

running (00m00.1s), 0/1 VUs, 1 complete and 0 interrupted iterations
default ✓ [ 100% ] 1 VUs  00m00.1s/10m0s  1/1 shared iters

++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

нагрузочные тесты k6-loadtest.js:
тесты используют заранее созданные данные: 20 команди 200 пользователей (создаются data-for-tests.js)
